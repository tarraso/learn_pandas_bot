...
# Parse ALLOWED_HOSTS - always include production domain
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'pandadev.taras.rocks', '.ngrok-free.app']
...
# Using CompressedStaticFilesStorage instead of Manifest version to avoid hash issues
STORAGES = {
    "default": {
